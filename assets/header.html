...
<body>
    <header id ="Header">
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
                <div id="Barra_NavBar_Blanca" class="container-fluid">
                    ...
                    <ul id="Contenido_NavBar_B"class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
